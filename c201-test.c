...
int main(int argc, char *argv[])	{
	...
	printf("\n[CUSTOMTEST1]\n");
    printf("Otestujeme funkčnost operace DisposeList s prazdnym seznamem.\n");
    printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    test_DisposeList();

	printf("\n[CUSTOMTEST2]\n");
    printf("Pridame prvek do seznamu a otestujeme funkčnost operace DisposeList s seznamem o velikosti 1 prvku.\n");
    printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	ElemValue = 1; test_InsertFirst();
    test_DisposeList();

	printf("\n[CUSTOMTEST3]\n");
	printf("Otestujeme First na prazdnem seznamu.\n");
	printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	test_First();
	test_Active();

	printf("\n[CUSTOMTEST4]\n");
    printf("Otestujeme DeleteFirst na prazdnem seznamu.\n");
    printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	test_DeleteFirst();

	printf("\n[CUSTOMTEST5]\n");
    printf("Otestujeme DeleteFirst na seznamu s jedinym prvkem.\n");
    printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	ElemValue = 1; test_InsertFirst();
    test_DeleteFirst();

	printf("\n[CUSTOMTEST6]\n");
    printf("Otestujeme PostInsert na stredecnem prvku.\n");
    printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	ElemValue = 1; test_InsertFirst();
	ElemValue = 2; test_InsertFirst();
	ElemValue = 3; test_InsertFirst();
